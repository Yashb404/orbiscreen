...
[![الإصدار](https://img.shields.io/badge/version-0.28.1-2563eb?style=flat-square&logo=semver)](../CHANGELOG.md)
...
مصفوفة الإصدار: `0.28.1` (مساحة العمل)، `versionCode = 94` (Android). ملاحظة: keystore إصدار Android لم تعد مضمنة في المستودع - راجع SECURITY.md؛ وفّر `ORBISCREEN_KEYSTORE_PATH`/`ORBISCREEN_STORE_PASSWORD`/`ORBISCREEN_KEY_ALIAS`/`ORBISCREEN_KEY_PASSWORD` عند بناء APK الإصدار.
