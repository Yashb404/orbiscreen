...
[![Version](https://img.shields.io/badge/version-0.28.7-2563eb?style=flat-square&logo=semver)](../CHANGELOG.md)
...
- `Cargo.toml`: `[workspace.package].version = "0.28.7"`
- `clients/android/app/build.gradle.kts`: `versionName = "0.28.7"`, `versionCode` incremented
- `crates/orbiscreen-gui/tauri.conf.json`: `"version": "0.28.7"`
- `PKGBUILD`: `pkgver=0.28.7`
- `debian/changelog`: new entry for `0.28.7-1`
- `data/orbiscreen-copr.spec`: `Version: 0.28.7`
- `Cargo.toml`: `[workspace.package].version = "0.28.8"`
- `clients/android/app/build.gradle.kts`: `versionName = "0.28.8"`, `versionCode` incremented
- `crates/orbiscreen-gui/tauri.conf.json`: `"version": "0.28.8"`
- `PKGBUILD`: `pkgver=0.28.8`
- `debian/changelog`: new entry for `0.28.8-1`
- `data/orbiscreen-copr.spec`: `Version: 0.28.8`
...
The release matrix is: `0.28.7` (workspace), `versionCode = 100` (Android). The Android release keystore is no longer shipped in the repo (see SECURITY.md); supply `ORBISCREEN_KEYSTORE_PATH`/`ORBISCREEN_STORE_PASSWORD`/`ORBISCREEN_KEY_ALIAS`/`ORBISCREEN_KEY_PASSWORD` when building a release APK.
The release matrix is: `0.28.8` (workspace), `versionCode = 101` (Android). The Android release keystore is no longer shipped in the repo (see SECURITY.md); supply `ORBISCREEN_KEYSTORE_PATH`/`ORBISCREEN_STORE_PASSWORD`/`ORBISCREEN_KEY_ALIAS`/`ORBISCREEN_KEY_PASSWORD` when building a release APK.
